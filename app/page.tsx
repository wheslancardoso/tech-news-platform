    ...
    <div className="min-h-screen bg-background font-sans flex flex-col has-bottom-nav">
      ...
      <main className="flex-grow">
        ...
        <section id="subscribe" className="relative py-16 md:py-28 overflow-hidden scanline">
          ...
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[hsl(var(--primary))] to-transparent opacity-60" />

          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              {/* Edition tag */}
              <div className="flex items-center gap-3 mb-8">
                <div className="w-2 h-2 bg-[hsl(var(--primary))] pulse-live" />
              ...
              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-[-0.04em] leading-[0.95] text-foreground mb-6">
                AS NOTÍCIAS<br/>
                DE TECH QUE<br/>
                <span className="text-[hsl(var(--primary))]">IMPORTAM.</span>
              </h1>
        ...
        <section id="archive" className="py-16 md:py-24 border-t-2 border-border">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="flex items-end justify-between mb-10">
              <div>
                <span className="text-[10px] font-mono text-[hsl(var(--primary))] tracking-widest uppercase block mb-2">// TRANSMISSÕES</span>
